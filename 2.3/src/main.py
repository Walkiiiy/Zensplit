...
img_path = '/home/walkiiiy/Zensplit/2.3/src/rawpic/1.JPG'  # 设置图像路径，必须是相对路径且不能有中文
txtpath = '/home/walkiiiy/Zensplit/2.3/src/ocr_outcome.txt'
outcomepath = "/home/walkiiiy/Zensplit/2.3/src/outcome/outcome.jpg"
...
if __name__ == '__main__':
    ...
    for ordinate in ordinats_Zen:
        cv2.rectangle(img_res, (ordinate[0][0], ordinate[1][0]),
                      (ordinate[0][1], ordinate[1][1]), (255, 0, 0), 1)

    # 显示和存储图片
    # cv2.imshow('outcome',img_cut)
    # cv2.waitKey(0)
    cv2.imwrite(outcomepath, img_res)
