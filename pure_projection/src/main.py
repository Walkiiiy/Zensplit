...
img_path='/home/walkiiiy/Zensplit/pure_projection/src/rawpic/数字.png'#设置图像路径，必须是相对路径且不能有中文
if __name__=='__main__':
    ...
    i=0
    k=0
    for item in ordinats:
        if item[1][0]!=i:
            i=item[1][0]
            k+=1
        print(item[0][1]-item[0][0],'第%d行'%(k))
    ...
    # cv2.waitKey(0)
    cv2.imwrite("/home/walkiiiy/Zensplit/pure_projection/src/outcome/数字.jpg", img_cut)
